...
## Authentication
Employee management endpoints require JWT authentication with Admin or SuperAdmin role. Include the token in the Authorization header:
```
...
**Description:** Creates a new Employee account. Only Admin or SuperAdmin can access this endpoint.
...
- Duplicate email, username, and employeeId prevention
